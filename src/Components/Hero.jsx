...
const HeroData = [
  {
    ...
    title: "Orange Fanta",
    subtitle:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique doloribus excepturi soluta voluptate assumenda maxime animi modi ut commodi. Tenetur voluptatum praesentium ducimus! Fugiat at ab eius voluptatibus aspernatur similique",
    price: "$40",
    modal: "Orange",
    bgColor: "#cf4f00",
  },
        ...
        <div className="  container grid grid-cols-1 md:grid-cols-2 min-h-[605px]">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="text-white/5 text-[300px] font-poppins font-extrabold absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/4  "
            >
              {activeData.modal}
            </motion.div>
          </AnimatePresence>
